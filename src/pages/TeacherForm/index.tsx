...
function TeacherForm() {
  ...
  function setScheduleItemsValue(position: number, field: string, value: string) {
    ...
    return setScheduleItems(updateScheduleItems);
  }
      ...
      <main>
        <form onSubmit={handleCreateClass}>
          <fieldset>
            ...
            <Input label="WhatsApp" placeholder="5521998989898" name="whatsapp" value={whatsapp} onChange={(e) => {setWhatsapp(e.target.value)}} />
